define(["require", "exports", "control", "./menu.scss"], function (require, exports, control_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * 表示一个菜单。
     */
    class Menu extends control_1.Control {
        /**
         * 当被子类重写时负责渲染当前控件。
         * @return 返回一个虚拟节点。
         */
        render() {
            return control_1.VNode.create("div", { class: "x-menu" });
        }
    }
    exports.Menu = Menu;
     ...
     * 3. 静态菜单。
     */
    var Menu = control_1.Control.extend({
        role: "menu",
        /**
         * 获取当前菜单的父菜单。
