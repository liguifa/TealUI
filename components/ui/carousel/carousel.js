define(["require", "exports", "control", "./carousel.scss"], function (require, exports, control_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * 表示一个图片轮播。
     */
    class Carousel extends control_1.Control {
        /**
         * 当被子类重写时负责渲染当前控件。
         * @return 返回一个虚拟节点。
         */
        render() {
            return control_1.VNode.create("div", { class: "x-carousel" });
        }
    }
    ...
    var Carousel = control_1.Control.extend({
        cssClass: 'x-carousel',
        ...
        init: function (options) {
            var me = this, width = Dom.getWidth(me.elem), items = me.items = Dom.query('.' + this.cssClass + '-body > li', me.elem).hide();
        ...
        _slideTo: function (fromIndex, toIndex, ltr) {
            var me = this, width = Dom.getWidth(me.elem);
        ...
        moveTo: function (index, ltr) {
            var timer = this.timer, currentIndex = this.currentIndex;
            if (timer) {
                clearTimeout(timer);
            }
