define(["require", "exports", "control", "./navTree.scss"], function (require, exports, control_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * 表示一个导航树。
     */
    class NavTree extends control_1.Control {
        /**
         * 当被子类重写时负责渲染当前控件。
         * @return 返回一个虚拟节点。
         */
        render() {
            return control_1.VNode.create("div", { class: "x-navtree" });
        }
    }
    exports.NavTree = NavTree;
    exports.default = NavTree;
    typeof include === "function" && include("../control/base, "););
    var Tree = control_1.Control.extend({
        init: function () {
            var me = this;
        ...
        setCollapsed: function (treeItem, value) {
            var icon = treeItem.querySelector('.x-icon:first-child'), subTree = this.getSubTree(treeItem);
