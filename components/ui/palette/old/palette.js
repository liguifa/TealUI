...
var Palette = Control.extend({
    ...
    _create: function () {
        ...
        switch (this.element.get(0).tagName) {
            case 'INPUT':
                var color = this.options.color, e = this.element;
                this._isPopup = true;
                this._palette = null;
                if (color != null) {
                    e.val(color);
    ...
    _paletteHTML: function () {
        ...
        h.push('<div class="evo-pop', _ie, ' x-widget x-widget-content x-corner-all"', this._isPopup ? ' style="position:absolute"' : '', '>');
    ...
    _paletteHTML1: function () {
        var h = [], labels = this.options.strings.split(','), oTD = '<td style="background-color:#', cTD = isIE ? '"><div style="width:2px;"></div></td>' : '"><span/></td>', oTRTH = '<tr><th colspan="10" class="x-widget-content">';
        // base theme colors
    ...
    _paletteHTML2: function () {
        ...
        ;
        var h = [], oTD = '<td style="background-color:#', cTD = isIE ? '"><div style="width:5px;"></div></td>' : '"><span/></td>', oTableTR = '<table class="evo-palette2' + _ie + '"><tr>', cTableTR = '</tr></table>';
    ...
    _switchPalette: function (link) {
        if (this._enabled) {
            ...
            if ($(link).hasClass('evo-hist')) {
                ...
                h.push('</div>');
                var idx = -this._paletteIdx, content = h.join(''), label = labels[4];
            }
            else {
                // palette
                ...
                var content = this['_paletteHTML' + idx](), label = labels[idx + 1];
...
(function ($, undefined) {
    var _idx = 0, isIE = $.browser.msie, _ie = isIE ? '-ie' : '', history = [], baseThemeColors = ['ffffff', '000000', 'eeece1', '1f497d', '4f81bd', 'c0504d', '9bbb59', '8064a2', '4bacc6', 'f79646'], subThemeColors = ['f2f2f2', '7f7f7f', 'ddd9c3', 'c6d9f0', 'dbe5f1', 'f2dcdb', 'ebf1dd', 'e5e0ec', 'dbeef3', 'fdeada',
        'd8d8d8', '595959', 'c4bd97', '8db3e2', 'b8cce4', 'e5b9b7', 'd7e3bc', 'ccc1d9', 'b7dde8', 'fbd5b5',
        'bfbfbf', '3f3f3f', '938953', '548dd4', '95b3d7', 'd99694', 'c3d69b', 'b2a2c7', '92cddc', 'fac08f',
        'a5a5a5', '262626', '494429', '17365d', '366092', '953734', '76923c', '5f497a', '31859b', 'e36c09',
        '7f7f7f', '0c0c0c', '1d1b10', '0f243e', '244061', '632423', '4f6128', '3f3151', '205867', '974806'], standardColors = ['c00000', 'ff0000', 'ffc000', 'ffff00', '92d050', '00b050', '00b0f0', '0070c0', '002060', '7030a0'], moreColors = [
    ...
    function paletteTemplate(p, color, className, opts) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            if (current) {
                ...
                html.push('<span title="' + formattedString + '" x-color="' + tiny.toRgbString() + '" class="' + c + '"><span class="sp-thumb-inner" style="' + swatchStyle + ';" /></span>');
            }
            else {
                var cls = 'sp-clear-display';
                html.push($('<div />')
                    .append($('<span x-color="" style="background-color:transparent;" class="' + cls + '"></span>')
