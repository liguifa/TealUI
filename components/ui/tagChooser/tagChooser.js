define(["require", "exports", "control", "./tagChooser.scss"], function (require, exports, control_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * 表示一个标签选择器。
     */
    class TagChooser extends control_1.Control {
        /**
         * 当被子类重写时负责渲染当前控件。
         * @return 返回一个虚拟节点。
         */
        render() {
            return control_1.VNode.create("div", { class: "x-tagchooser" });
        }
    }
    exports.TagChooser = TagChooser;
    exports.default = TagChooser;
    // #todo
    /**
     * @fileOverview 标签选择器。
     ...
     * 一个标签选择器。
     */
    var TagChooser = control_1.Control.extend({
        role: 'tagchooser',
...
//# sourceMappingURL=tagChooser.js.map