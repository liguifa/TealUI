...
function generatePager(totalCount, pageSize, pagerCount, currentPage, href) {
    ...
    var maxPage = Math.ceil(totalCount / pageSize), page = Math.max(Math.min(currentPage - Math.floor(pagerCount / 2), maxPage - pagerCount + 1), 1), html = '';
...
//# sourceMappingURL=pager (2).js.map