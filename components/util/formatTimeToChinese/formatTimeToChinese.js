define(["require", "exports"], function (require, exports) {
     ...
     */
    function formatTimeToChinese(date, now = new Date()) {
        const timeOffset = Math.round((now - date) / 1000);
        let t;
    ...
    exports.default = formatTimeToChinese;
});
//# sourceMappingURL=formatTimeToChinese.js.map