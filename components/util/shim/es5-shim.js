define(["require", "exports", "./json-shim"], function (require, exports) {
     ...
     */
    Array.prototype.indexOf = Array.prototype.indexOf || function (value, startIndex = 0) {
     ...
     * @see https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/indexOf
     */
    Array.prototype.lastIndexOf = Array.prototype.lastIndexOf || function (value, startIndex = 0) {
     ...
     */
    Function.prototype.bind = Function.prototype.bind || function (scope, ...args) {
        return (...args2) => {
