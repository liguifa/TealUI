define(["require", "exports", "assert", "./es5-shim", "./es6-shim", "./es7-shim"], function (require, exports, assert) {
    ...
    exports.includesTest = includesTest;
    function fillTest() {
        const foo = [1, 2];
        foo.fill(1);
        assert.deepEqual(foo, [1, 1]);
    }
    exports.fillTest = fillTest;
    function fromTest() {
    ...
    exports.startsWithTest = startsWithTest;
    function endsWithTest() {
        assert.strictEqual("1234567".endsWith("67"), true);
    }
    exports.endsWithTest = endsWithTest;
    function trimLeftTest() {
        assert.strictEqual("  a".trimLeft(), "a");
    }
    exports.trimLeftTest = trimLeftTest;
    function trimRightTest() {
        assert.strictEqual("a  ".trimRight(), "a");
    }
    exports.trimRightTest = trimRightTest;
    function repeatTest() {
    ...
    exports.padStartTest = padStartTest;
    function padEndTest() {
        assert.strictEqual("6".padEnd(3, "0"), "600");
    }
    exports.padEndTest = padEndTest;
    function nowTest() {
        assert.strictEqual(Date.now(), Date.now());
    }
    exports.nowTest = nowTest;
