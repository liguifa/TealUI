...
define(["require", "exports"], function (require, exports) {
    ...
    /**
     * 混淆指定的 JavaScript 代码。
     * @param {String} sourceCode 要混淆的代码。
     * @param {Boolean} [asciiEncoding] 是否使用 ASCII 编码。
     * @param {Boolean} [fastDecode] 是否允许快速解码。
     * @param {Boolean} [allowSepicalChars] 是否使用特殊字符串。
     * @returns {String} 返回已混淆的代码。
    ...
    /**
     * 取消混淆指定的 JavaScript 代码。
     * @param {String} obfuscatedCode 已混淆的代码。
     * @returns {String} 返回取消混淆的代码。
     * @example deobfuscate("var a =1")
     */
    function deobfuscate(obfuscatedCode) {
        if (/^eval\b/.test(obfuscatedCode)) {
            obfuscatedCode = eval(obfuscatedCode.substring(4));
        }
