...
Tween.engines = {
    ...
    color: {
        ...
        compute: function (from, to, delta) {
            var compute = Fx.numberTweener.compute, r = [
...
(function () {
    ...
    }, toggle = Dom.prototype.toggle, shift = Array.prototype.shift, height = 'height marginTop paddingTop marginBottom paddingBottom';
    ...
    Object.map('Left Right Top Bottom', function (key, index) {
        displayEffects[key.toLowerCase()] = function (options, elem, isShow) {
            ...
            var params = {}, fromValue, toValue, key2, delta;
            if (index <= 1) {
    ...
    Dom.defaultDisplay = function (elem) {
        var displays = Dom.displays || (Dom.displays = {}), tagName = elem.tagName, display = displays[tagName], iframe, iframeDoc;
        if (!display) {
