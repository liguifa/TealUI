...
scrollSpy: function () {
    var me = this, initY = me.getPosition().y, initP = me.getStyle('position'), initT = me.getStyle('top');
    if (navigator.isIE6) {
...
Element.implement({
     ...
     */
    setPin: (function () {
        var supportsPositionFixed = false, supportTested = false;
        ...
        return function (value, hideWhenScroll) {
            ...
            if (this.getStyle('display') == 'none')
                return this;
            var pinnedPosition, scroll = window.getScroll(), parent, scrollFixer;
            if (enable !== false) {
                ...
                if (!this.retrieve('pin:_pinned')) {
                    ...
                    if (supportsPositionFixed && !forceScroll) {
                        ...
                        var position = this.getPosition(parent), styles = this.getStyles('left', 'top');
...
//# sourceMappingURL=scrollSpy (2).js.map