 ...
 * @statable
 */
define(["require", "exports", "./refresh.css"], function (require, exports) {
    ...
    function refreshPage(obj) {
        var $target = obj.target, refreshCallback = obj.refreshCallback, startCallback = obj.startCallback, moveCallback = obj.moveCallback, endCallback = obj.endCallback, onShow = obj.onShow, scope = obj.scope, initAction = obj.init;
        var startY, moveY, moveEndY, firstPos, lastPos, firstTouch_obj, cur_top, startTimeStamp, endTimeStamp;
        ...
        $target.on('touchstart', function (e) {
            ...
            //title contain
            //判断是否已经展开， 展开  return
            if ($('.flight-info-detail').length > 0)
                return;
            //初始触摸的点
...
//# sourceMappingURL=touchRefresh.js.map