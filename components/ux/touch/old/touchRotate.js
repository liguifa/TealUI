...
Dom.prototype.touchRotate = function (options) {
    ...
    this.on('touchstart', function (e) {
        $(this).html('asd');
        var touches = e.touches, x1 = touches[0].pageX, y1 = touches[0].pageY, x2 = touches[touches.length - 1].pageX, y2 = touches[touches.length - 1].pageY;
...
//# sourceMappingURL=touchRotate.js.map